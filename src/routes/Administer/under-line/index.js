...
class Video extends React.Component {
  ...
  render() {
    const columns = [
      ...
      {
        title: '预约人数',
        dataIndex: 'courseAppointmentCount',
        key: 'courseAppointmentCount',
      },
      {
        title: '签到人数',
        dataIndex: 'courseSigninUserCount',
        key: 'courseSigninUserCount',
      },
      {
        title: '完成率',
          ...
          <div className="top-info"> 
              ...
              <Col span={8}>
                <Card bordered={false}>
                  <Meta
                    ...
                    title={this.state.yesData.yesterdayOfflineCourseCount}
                    description="昨日面授课程数"/>
                </Card>
              </Col>
              <Col span={8}>
              ...
              <Col span={8}>
                <Card bordered={false}>
                  <Meta
                    ...
                    style={{textAlign:"center"}}
                    title={this.state.yesData.yesterdaySigninUserCount}
                    description="昨日课程签到人数"/>
                </Card>
              </Col>
            </Row>
          </div>
            <Card className="tableList" bordered={false}>
              <SeachForm
                ...
                downloadApi = {api.offlineExportVideoCourse}
                title="面授课程"/>  
            </Card>
